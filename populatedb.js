  ...
  async.parallel(
    [
      ...
      function (callback) {
        categoryCreate(
          "CPU Cooler",
          "A heatsink and fan (HSF), also known as a CPU Cooler, sits atop the CPU to draw heat away from the CPU and disperse it, because CPUs produce heat while operating.",
          callback
        );
      },
      function (callback) {
  ...
  async.parallel(
    [
      function (callback) {
        manufacturerCreate(
          "NVIDIA",
          "NVIDIA, inventor of the GPU, which creates interactive graphics on laptops, workstations, mobile devices, notebooks, PCs, and more. NVIDIA created the world's ",
          callback
        );
      },
      function (callback) {
        manufacturerCreate(
          "Intel",
          "Intel's innovation in cloud computing, data center, Internet of Things, and PC solutions is powering",
          callback
        );
      },
    ],
